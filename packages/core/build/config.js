...
const copyConfig = base => {
    const patterns = [
        ...
        { from: path.resolve(__dirname, '../src/root_files/_headers'), to: '_headers', toType: 'file' },
        { from: path.resolve(__dirname, '../src/root_files/_worker.js'), to: '_worker.js', toType: 'file' },
